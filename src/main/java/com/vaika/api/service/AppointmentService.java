...
public class AppointmentService {
    ...
    public Page<Appointment> findAppointmentsByStatus(AppointmentStatusEnum status, int pageNumber, int pageSize) {
    ...
    public Appointment save(AppointmentDao toSave) {
        ...
        appointment.setCar( carRepository.findById(toSave.getIdCar())
                .orElseThrow(() -> new NotFoundException("Car with id : " + toSave.getIdCar() + " not found")));
        return appointmentRepository.save(appointment);
    }

    public Appointment update(AppointmentDao toUpdate){
        Appointment appointment = appointmentRepository.findById(toUpdate.getId())
        ...
        appointment.setCar(carRepository.findById(toUpdate.getIdCar())
                .orElseThrow(() -> new NotFoundException("Car with id : " + toUpdate.getIdCar() + " not found")));
        appointment.setStatus(AppointmentStatusEnum.PENDING);
